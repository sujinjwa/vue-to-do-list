...
/* header */
h1 {font-family: 'Merriweather Sans', sans-serif; font-weight: 600;}

/* page */
.page {max-width: 1000; margin:40px auto; width:80%}
.todos {font-size:1.2rem; margin:20px 0 0; position:relative;}
.todos .write {display:inline-block; background-color:#f3f2eb; padding:10px 15px; border-radius:30px; margin-left:-20px; position:absolute;}
.todos .write > input {
    font-size:24px;
    border:none; 
    padding:5px 10px; 
